...
var SimpleCalendar = function () {
  ...
  function SimpleCalendar(query, options,selectdaycallback,iscallback) {
    ...
    value: function updateEvent() {
      ...
      daysElement.forEach(function (v, i) {
        ...
        v.onclick = function () {
          ...
          //alert(calendar.getSelectedDay());
          calendar.selectdaycallback.call(this,calendar.getSelectedDay());
